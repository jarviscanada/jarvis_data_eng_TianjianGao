...
(
    ...
    (
        ...
        ADD CONSTRAINT bookings_pk PRIMARY KEY
        (bookid);
        ...
        ADD CONSTRAINT facilities_pk PRIMARY KEY
        (facid);
        ...
        ALTER TABLE ONLY bookings
        ADD CONSTRAINT fk_bookings_facid FOREIGN KEY
        ...
        ALTER TABLE ONLY bookings
        ADD CONSTRAINT fk_bookings_memid FOREIGN KEY
        ...
        ALTER TABLE ONLY members
        ADD CONSTRAINT fk_members_recommendedby FOREIGN KEY
        (recommendedby) REFERENCES members
        (memid) ON
        DELETE
        SET NULL;
